...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df, values='class', names=filtered_df['Launch Site'], title='Total Succes Launches by Site')
        return fig
    else:
        filtered_df = spacex_df[spacex_df['Launch Site']==entered_site]
        counts = filtered_df['class'].value_counts()
        fig = px.pie(names=counts.index, values=counts.values, title='Total Succes Launches for Site ' + entered_site)
        return fig
